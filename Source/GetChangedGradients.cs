...
public static class GetChangedGradients
{
    public static Gradient GetChangedGradient(this FactionType faction, Role role)
    {
        ...
        if (Fancy.MajorColors.Value && (role.GetSubAlignment() == SubAlignment.POWER || role is Role.FAMINE or Role.WAR or Role.PESTILENCE or Role.DEATH))
        {
            switch (faction)
            {
                ...
                case (FactionType)33:
                    switch (Fancy.RecruitEndingColor.Value)
                    {
                        ...
                        case RecruitEndType.FactionStart:
                            array[0] = new(Fancy.Colors["JACKAL"].Start.ToColor(), 0f);
                            array[1] = role.GetFaction() switch
                            {
                                FactionType.TOWN => new(Fancy.Colors["TOWN"].Start.ToColor(), 1f),
                                FactionType.COVEN => new(Fancy.Colors["COVEN"].Start.ToColor(), 1f),
                                FactionType.SERIALKILLER => new(Fancy.Colors["SERIALKILLER"].Start.ToColor(), 1f),
                                FactionType.ARSONIST => new(Fancy.Colors["ARSONIST"].Start.ToColor(), 1f),
                                FactionType.WEREWOLF => new(Fancy.Colors["WEREWOLF"].Start.ToColor(), 1f),
                                FactionType.SHROUD => new(Fancy.Colors["SHROUD"].Start.ToColor(), 1f),
                                FactionType.APOCALYPSE => new(Fancy.Colors["APOCALYPSE"].Start.ToColor(), 1f),
                                FactionType.EXECUTIONER => new(Fancy.Colors["EXECUTIONER"].Start.ToColor(), 1f),
                                FactionType.JESTER => new(Fancy.Colors["JESTER"].Start.ToColor(), 1f),
                                FactionType.PIRATE => new(Fancy.Colors["PIRATE"].Start.ToColor(), 1f),
                                FactionType.DOOMSAYER => new(Fancy.Colors["DOOMSAYER"].Start.ToColor(), 1f),
                                FactionType.VAMPIRE => new(Fancy.Colors["VAMPIRE"].Start.ToColor(), 1f),
                                FactionType.CURSED_SOUL => new(Fancy.Colors["CURSEDSOUL"].Start.ToColor(), 1f),
                                (FactionType)38 => new(Fancy.Colors["JUDGE"].Start.ToColor(), 1f),
                                (FactionType)39 => new(Fancy.Colors["AUDITOR"].Start.ToColor(), 1f),
                                (FactionType)40 => new(Fancy.Colors["INQUISITOR"].Start.ToColor(), 1f),
                                (FactionType)41 => new(Fancy.Colors["STARSPAWN"].Start.ToColor(), 1f),
                                _ => new(Fancy.Colors["JACKAL"].Major.ToColor(), 1f)
                            };
                            goto setmajor;
                        ...
                        case RecruitEndType.FactionEnd:
                            ...
                            array[1] = role.GetFaction() switch
                            {
                                FactionType.TOWN => new(Fancy.Colors["TOWN"].Major.ToColor(), 1f),
                                FactionType.COVEN => new(Fancy.Colors["COVEN"].Major.ToColor(), 1f),
                                FactionType.SERIALKILLER => new(Fancy.Colors["SERIALKILLER"].Major.ToColor(), 1f),
                                FactionType.ARSONIST => new(Fancy.Colors["ARSONIST"].Major.ToColor(), 1f),
                                FactionType.WEREWOLF => new(Fancy.Colors["WEREWOLF"].Major.ToColor(), 1f),
                                FactionType.SHROUD => new(Fancy.Colors["SHROUD"].Major.ToColor(), 1f),
                                FactionType.APOCALYPSE => new(Fancy.Colors["APOCALYPSE"].Major.ToColor(), 1f),
                                FactionType.EXECUTIONER => new(Fancy.Colors["EXECUTIONER"].End.ToColor(), 1f),
                                FactionType.JESTER => new(Fancy.Colors["JESTER"].End.ToColor(), 1f),
                                FactionType.PIRATE => new(Fancy.Colors["PIRATE"].End.ToColor(), 1f),
                                FactionType.DOOMSAYER => new(Fancy.Colors["DOOMSAYER"].End.ToColor(), 1f),
                                FactionType.VAMPIRE => new(Fancy.Colors["VAMPIRE"].Major.ToColor(), 1f),
                                FactionType.CURSED_SOUL => new(Fancy.Colors["CURSEDSOUL"].Major.ToColor(), 1f),
                                (FactionType)38 => new(Fancy.Colors["JUDGE"].End.ToColor(), 1f),
                                (FactionType)39 => new(Fancy.Colors["AUDITOR"].End.ToColor(), 1f),
                                (FactionType)40 => new(Fancy.Colors["INQUISITOR"].End.ToColor(), 1f),
                                (FactionType)41 => new(Fancy.Colors["STARSPAWN"].End.ToColor(), 1f),
                                _ => new(Fancy.Colors["JACKAL"].Major.ToColor(), 1f)
                            };
                            goto setmajor;
        ...
        if (Fancy.LethalColors.Value && (role.GetSubAlignment() == SubAlignment.KILLING || role == Role.BERSERKER || role == Role.JAILOR && !Fancy.MajorColors.Value))
        {
            switch (faction)
            {
                case FactionType.TOWN:
                    ...
                    switch (Fancy.RecruitEndingColor.Value)
                    {
                        ...
                        case RecruitEndType.FactionStart:
                            ...
                            array[1] = role.GetFaction() switch
                            {
                                ...
                                (FactionType)40 => new(Fancy.Colors["INQUISITOR"].Start.ToColor(), 1f),
                                (FactionType)41 => new(Fancy.Colors["STARSPAWN"].Start.ToColor(), 1f),
                                _ => new(Fancy.Colors["JACKAL"].Lethal.ToColor(), 1f)
                            };
                            goto setlethal;
                        ...
                        case RecruitEndType.FactionEnd:
                            ...
                            array[1] = role.GetFaction() switch
                            {
                                FactionType.TOWN => new(Fancy.Colors["TOWN"].Lethal.ToColor(), 1f),
                                FactionType.COVEN => new(Fancy.Colors["COVEN"].Lethal.ToColor(), 1f),
                                FactionType.SERIALKILLER => new(Fancy.Colors["SERIALKILLER"].End.ToColor(), 1f),
                                FactionType.ARSONIST => new(Fancy.Colors["ARSONIST"].End.ToColor(), 1f),
                                FactionType.WEREWOLF => new(Fancy.Colors["WEREWOLF"].End.ToColor(), 1f),
                                FactionType.SHROUD => new(Fancy.Colors["SHROUD"].End.ToColor(), 1f),
                                FactionType.APOCALYPSE => new(Fancy.Colors["APOCALYPSE"].Lethal.ToColor(), 1f),
                                FactionType.EXECUTIONER => new(Fancy.Colors["EXECUTIONER"].End.ToColor(), 1f),
                                FactionType.JESTER => new(Fancy.Colors["JESTER"].End.ToColor(), 1f),
                                FactionType.PIRATE => new(Fancy.Colors["PIRATE"].End.ToColor(), 1f),
                                FactionType.DOOMSAYER => new(Fancy.Colors["DOOMSAYER"].End.ToColor(), 1f),
                                FactionType.VAMPIRE => new(Fancy.Colors["VAMPIRE"].Lethal.ToColor(), 1f),
                                FactionType.CURSED_SOUL => new(Fancy.Colors["CURSEDSOUL"].Lethal.ToColor(), 1f),
                                (FactionType)38 => new(Fancy.Colors["JUDGE"].End.ToColor(), 1f),
                                (FactionType)39 => new(Fancy.Colors["AUDITOR"].End.ToColor(), 1f),
                                (FactionType)40 => new(Fancy.Colors["INQUISITOR"].End.ToColor(), 1f),
                                (FactionType)41 => new(Fancy.Colors["STARSPAWN"].End.ToColor(), 1f),
                ...
                switch (Fancy.RecruitEndingColor.Value)
                {
                    ...
                    case RecruitEndType.FactionStart:
                        ...
                        array[1] = role.GetFaction() switch
                        {
                            ...
                            (FactionType)40 => new(Fancy.Colors["INQUISITOR"].Start.ToColor(), 1f),
                            (FactionType)41 => new(Fancy.Colors["STARSPAWN"].Start.ToColor(), 1f),
                            _ => new(Fancy.Colors["JACKAL"].End.ToColor(), 1f)
                        };
                        goto setgradient;
                    ...
                    case RecruitEndType.FactionEnd:
                        ...
                        array[1] = role.GetFaction() switch
                        {
                            FactionType.TOWN => new(Fancy.Colors["TOWN"].End.ToColor(), 1f),
                            FactionType.COVEN => new(Fancy.Colors["COVEN"].End.ToColor(), 1f),
                            FactionType.SERIALKILLER => new(Fancy.Colors["SERIALKILLER"].End.ToColor(), 1f),
                            FactionType.ARSONIST => new(Fancy.Colors["ARSONIST"].End.ToColor(), 1f),
                            FactionType.WEREWOLF => new(Fancy.Colors["WEREWOLF"].End.ToColor(), 1f),
                            FactionType.SHROUD => new(Fancy.Colors["SHROUD"].End.ToColor(), 1f),
                            FactionType.APOCALYPSE => new(Fancy.Colors["APOCALYPSE"].End.ToColor(), 1f),
                            FactionType.EXECUTIONER => new(Fancy.Colors["EXECUTIONER"].End.ToColor(), 1f),
                            FactionType.JESTER => new(Fancy.Colors["JESTER"].End.ToColor(), 1f),
                            FactionType.PIRATE => new(Fancy.Colors["PIRATE"].End.ToColor(), 1f),
                            FactionType.DOOMSAYER => new(Fancy.Colors["DOOMSAYER"].End.ToColor(), 1f),
                            FactionType.VAMPIRE => new(Fancy.Colors["VAMPIRE"].End.ToColor(), 1f),
                            FactionType.CURSED_SOUL => new(Fancy.Colors["CURSEDSOUL"].End.ToColor(), 1f),
                            (FactionType)38 => new(Fancy.Colors["JUDGE"].End.ToColor(), 1f),
                            (FactionType)39 => new(Fancy.Colors["AUDITOR"].End.ToColor(), 1f),
                            (FactionType)40 => new(Fancy.Colors["INQUISITOR"].End.ToColor(), 1f),
                            (FactionType)41 => new(Fancy.Colors["STARSPAWN"].End.ToColor(), 1f),
