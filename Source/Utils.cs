...
public static class Utils
{
    ...
    private static readonly string[] BTOS2SkippableNames = [ "Baker_Ability_1", "Jackal_Ability", "Auditor_Ability_1", "Auditor_Ability_2", "Inquisitor_Ability_1", "Inquisitor_Ability_2", "Banshee_Ability", "Judge_Ability",
        "Warlock_Ability", "Starspawn_Ability", "Dreamweaver_Ability_2", "Illusionist_Ability_2", "Pacifist_Ability_2", "Archmage_Ability", "Mayor_Ability", "SerialKiller_Ability_1", "SerialKiller_Ability_2" ];
    ...
    private static string BTOSRoleName(Role role) => role switch
    {
        ...
        Btos2Role.RandomApocalypse => "Apocalypse",
    ...
    private static string VanillaRoleName(Role role) => role switch
    {
        ...
        Role.NEUTRAL_APOCALYPSE => "Apocalypse",
        Role.ANY => "Any",
