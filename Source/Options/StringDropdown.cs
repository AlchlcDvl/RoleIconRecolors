...
public class StringDropdownOption(string id, string defaultValue, PackType page, Func<string[]> options, Func<bool> setActive = null, Func<string, string> mapping = null, Action<string> onChanged
