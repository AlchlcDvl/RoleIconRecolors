...
public abstract class BaseDropdownOption<T>(string id, T defaultValue, PackType page, Func<IEnumerable<string>> options, Func<T, bool> setActive = null, Func<string, string>
